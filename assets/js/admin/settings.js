(function ($) {
  ...
  $.ADMSettings = function (base, message) {
    ...
    $(defaults.importLearningPathBtn).on(
      'click',
      function(){
        ...
        self.importLearningPathes(button);
      }
    );
  ...
  $.ADMSettings.prototype = {
    ...
    importLearningPathes: function(button) {
      var self = this;
      var defaults = $.ADMSettings.defaults;
      var baseDefaults  = $.ADMBase.defaults;
      ...
      var data = {
        "_uri" : "settings/importLearningPathes",
        "page" : page,
        "per_page" : per_page,
        "imported" : imported,
        "exists" : exists,
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.message) {
            $(defaults.importInfoLp).html(response.message);
          }
        }
      });
    }
